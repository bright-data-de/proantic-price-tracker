# Proantic Price Tracker

[![Bright Data](https://img.shields.io/badge/Powered%20by-Bright%20Data-blue?style=flat-square)](https://brightdata.de)
[![Proantic Price Tracker](https://img.shields.io/badge/Proantic%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/proantic)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/proantic)

Echtzeit-Proantic-Preisverfolgung – ein französischer Online-Marktplatz für Antiquitäten und Vintage-Sammlerstücke. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit dem AI Scraper Builder von Bright Data.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/proantic)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Proantic-Preise überwachen** über alle Produktkategorien hinweg
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/proantic)**

---

## Option 2: Eigenen Proantic-Scraper erstellen

Keine vorgefertigte Proantic-Scraper-API? Kein Problem. Der **AI Scraper Builder** von Bright Data erstellt in nur wenigen Klicks einen benutzerdefinierten Proantic-Scraper — ganz ohne Programmierung.

### Ihren Proantic-Scraper in wenigen Minuten erstellen

**[Den Proantic AI Scraper Builder öffnen →](https://brightdata.de/products/web-scraper/proantic)**
...
- Eine **Web Scraper ID** für Proantic (aus dem obigen Build-Schritt)
...
1. **Dieses repository klonen**
   ...
   ```bash
   git clone https://github.com/bright-data-de/proantic-price-tracker.git
   cd proantic-price-tracker
   ```
...
3. **Zugangsdaten konfigurieren**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/proantic)
...
Sobald Ihr Proantic-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf dieselbe Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Proantic-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.proantic.com/product/sample-item-123456",
...
Sammeln Sie alle Produkte von einer Proantic-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://proantic.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.proantic.com/product/sample-item-123456",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://proantic.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.proantic.com/product/sample-item-123456"}]
...
- 🌟 [Proantic Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/proantic)
- 🏗️ [Build a Proantic Scraper](https://brightdata.de/products/web-scraper/proantic)
